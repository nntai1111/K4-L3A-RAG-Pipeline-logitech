...
def rerank_rrf(
    ...
    for ranked_list in ranked_lists:
        # rank bắt đầu từ 1 — dùng 0 sẽ làm item đầu bảng có trọng số 1/k
        # lệch hẳn so với công thức chuẩn.
    ...
    # Tie-break theo thứ tự gặp lần đầu để kết quả ổn định giữa các lần chạy.
    ranked_ids = sorted(
        scores,
